...
\begin{description}
  \item[2020 -- 2022]{
        \textbf{Statistical Learning Seminar Series}, Main Organizer
...
\begin{description}[
    labelwidth = \widthof{qualpalr} + 1ex,
    leftmargin = \widthof{qualpalr} + 1ex,
  ]
  \item[SLOPE] {
        \textbf{Generalized linear models penalized with the sorted L1 norm}

        Author and maintainer, \texttt{R}, \url{https://CRAN.R-project.org/package=SLOPE}
        }

  \item[benchopt]{
        \textbf{Reproducible, efficient and collaborative optimization benchmarks}

        Contributor, \texttt{Python}, \url{https://benchopt.github.io/}
        }

  \item[eulerr]{
        \textbf{Area-proportional Euler diagrams with ellipses}

        Author and maintainer, \texttt{R}, \url{https://CRAN.R-project.org/package=eulerr}
        }
...
\begin{description}[
    labelwidth = \widthof{2018} + 1ex,
    leftmargin = \widthof{2018} + 1ex,
  ]
...
\begin{description}[
    labelwidth = \widthof{2021} + 1ex,
    leftmargin = \widthof{2021} + 1ex,
  ]
